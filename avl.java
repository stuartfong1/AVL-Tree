...
public class avl extends PApplet {
...
class Node
{
    ...
    public Node InsertBalance(int changedValue)
    {
        int balance = Balance();
        // Case 1: left -> left
...
public void PrintTree(Node n, int x, int y, int xd, int yd)
{
    if(n != null)
    {
        textSize(12);
    ...
    static public void main(String[] passedArgs) {
        String[] appletArgs = new String[] { "avl" };
        if (passedArgs != null) {
